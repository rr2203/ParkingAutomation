...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(12.933269,77.612035), // BLR
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(12.933269,77.612035),
        map: map,
        optimized: false,
        icon: image
    });
    ...
    var infoWindow = new google.maps.InfoWindow({
        content:
		'<h1 class="popover-map-title">Insanely Elegant</h1>'+
		'<div class="popover-map-caption">Insanely Elegant Studios, 91springboard, 7th Block Koramangala</div>'
    });
